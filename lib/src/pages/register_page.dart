              ...
              child: Center(
                ...
                //  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    Text("It's quick and easy to set up an account",style: TextStyle(color:Colors.grey,fontSize: 12, fontWeight: FontWeight.bold),),
                      ...
                      child: Column(
                          ...
                          Row(
                           ...
                           Row(
                            ...
                            Container(
                              child: Text(
                                "By creating an account, at Hub Bici you accept the terms of use and privacy policy.", textAlign: TextAlign.center, 
...
class _GlobalText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin:  EdgeInsets.symmetric(vertical:m.height*0.01, horizontal: m.width*0.08),
      child: TextField(
