            ...
            child: Center(
              child: ListView(
                children: [
                  ...
                  _Cuerpo(
                    "HubBici has at your disposal several places for the storage of bicycles in the different districts of Lima - Peru",
                  ...
                  _Cuerpo(
                      "You want to be part of the HubBici team, what are you waiting for? register your application and be a member of our family",
...
class _Titulo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.only(
          left: t.width * 0.3, right: t.width * 0.3, top: t.height * s),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: EdgeInsets.symmetric(
          vertical: t.height * 0.1, horizontal: t.width * 0.04),
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(
                "Select the service of ypur preference",
                style: TextStyle(
                    color: Colors.white,
                    fontSize: 15,
                    fontWeight: FontWeight.bold),
